...
// </auto-generated>
//------------------------------------------------------------------------------
#ifndef BLUEPRINTREFERENCE_H
#define BLUEPRINTREFERENCE_H
...
namespace Jetbrains {
    namespace EditorPlugin {
        ...
        class BlueprintReference : public rd::IPolymorphicSerializable
        {
            ...
            //primary ctor
            public:
            BlueprintReference(FString pathName_);
...
namespace rd {
    ...
    namespace std {
        ...
        template<size_t I>
        class std::tuple_element<I, Jetbrains::EditorPlugin::BlueprintReference> {
        public:
