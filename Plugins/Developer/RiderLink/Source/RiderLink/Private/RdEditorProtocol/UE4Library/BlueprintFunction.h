...
// </auto-generated>
//------------------------------------------------------------------------------
#ifndef BLUEPRINTFUNCTION_H
#define BLUEPRINTFUNCTION_H
...
/// <summary>
/// <p>Generated from: UE4Library.kt:113</p>
/// </summary>
namespace Jetbrains {
    namespace EditorPlugin {
        
        //data
        class BlueprintFunction : public rd::IPolymorphicSerializable
        {
...
namespace rd {
    ...
    namespace std {
        ...
        template<size_t I>
        class std::tuple_element<I, Jetbrains::EditorPlugin::BlueprintFunction> {
        public:
