...
// </auto-generated>
//------------------------------------------------------------------------------
#ifndef UNABLETODISPLAYSCRIPTCALLSTACK_H
#define UNABLETODISPLAYSCRIPTCALLSTACK_H
...
/// <summary>
/// <p>Generated from: UE4Library.kt:142</p>
/// </summary>
namespace Jetbrains {
    namespace EditorPlugin {
        class UnableToDisplayScriptCallStack : public IScriptCallStack
        {
...
//hash code trait
namespace rd {
    template <> struct hash<Jetbrains::EditorPlugin::UnableToDisplayScriptCallStack> {
...
#endif // UNABLETODISPLAYSCRIPTCALLSTACK_H
